            ...
            {isEmptyActivities ? <p className=" text-center my-5"> No Hay Actividades Aun</p>
                ...
                activities.map(activity => (
                    <div key={activity.id} className=" px-5 py-10 bg-white mt-5 flex justify-between shadow-lg">
                        <div className=" space-y-2 realtive">
                            <p
                                className={`relative -top-8 -left-8 px-10 py-2 text-white uppercase font-bold text-center 
                        ...
                        <div className=" flex gap-5 items-center">
                            ...
                            >
                                <PencilSquareIcon
                                    className="h-8 w-8 text-gray-700 hover:text-gray-900 cursor-pointer"
                                />
                            </button>
                            <button
                            ...
                            >
                                <XCircleIcon
                                    className="h-8 w-8 text-red-600 hover:text-red-800 cursor-pointer"
                                />
                            </button>
                        </div>
                    </div>
